from dataloaders.datasets import cityscapes, coco, combine_dbs, pascal, sbd, buildings
...
def make_data_loader(args, **kwargs):
    ...
    if args.dataset == 'buildings':
        train_set = buildings.BuildingSegmentation(args, split='train')
        val_set = buildings.BuildingSegmentation(args, split='val')
